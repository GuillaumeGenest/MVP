...
final class SignInAppleHelper: NSObject {
    ...
    private var isFirstTimeSignIn: Bool = false // Indicateur pour suivre si c'est une première connexion
    ...
    func startSignInWithAppleFlow(completion: @escaping (Result<SignInWithAppleResult, Error>) -> Void) {
        ...
        isFirstTimeSignIn = (completionHandler == nil) // Déterminer si c'est une première connexion
